...
//        ConfXYZ(nconf);//Write actual configuration in XYZ format //Commented to avoid "filesystem full"! 
  ...
  cout << "Final temperature: " << walker[it] << endl;    //Added
...
//Prepare arrays for measurements
  ...
  ie = 3; //Total energy
  iw = 4; //Pressure      //Added
  n_props = 5; //Number of observables     //Changed 4->5
...
//Additional equilibration  //Added
...
//Print initial values for measured properties
  ...
  // //Prime the gas (not needed)    //Added
  // if(InName=="gas"){
...
void Averages(int iblk) //Print results for current block
{
   ...
   ofstream Epot, Ekin, Etot, Temp, Pres;     // Added Pres
   const int wd=12;
    ...
    Epot.open("output_"+InName+"_epot.dat",ios::app);
    Ekin.open("output_"+InName+"_ekin.dat",ios::app);
    Temp.open("output_"+InName+"_temp.dat",ios::app);
    Etot.open("output_"+InName+"_etot.dat",ios::app);
    Pres.open("output_"+InName+"_pres.dat",ios::app);      // Added
